...
def get_correlations(df):
    ...
    df_melt_corr = df_corr.melt(id_vars='variable1', var_name='variable2', value_name='correlation')
    df_melt_corr = df_melt_corr[df_melt_corr.variable1 != df_melt_corr.variable2] # Remove self correlations 

    # Remove duplications
    df_melt_corr[['variable1', 'variable2']] = np.sort(df_melt_corr[['variable1', 'variable2']].values, axis=1)
